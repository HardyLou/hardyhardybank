    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDebitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cancel) {
                    ...
                    Intent i = new Intent(AccountAdminActivity.this, DebitActivity.class);
        ...
        mTransactionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cancel) {
                    ...
                    Intent i = new Intent(AccountAdminActivity.this, TransactionLogActivity.class);
                    i.putExtra("accountnumber", accountNumber);
                    i.putExtra("accountInfo", accountInfo);
                    i.putExtra("accountBalance", accountBalance);
                    startActivity(i);
        ...
        mCreditButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cancel) {
                    ...
                    // Go to Credit Activity
                    Intent i = new Intent(AccountAdminActivity.this, CreditActivity.class);
                    i.putExtra("accountnumber", accountNumber);
                    i.putExtra("accountInfo", accountInfo);
                    i.putExtra("accountBalance", accountBalance);
                    startActivity(i);
        ...
        mCloseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(AccountAdminActivity.this, CloseActivity.class);
                i.putExtra("accountnumber", accountNumber);
                i.putExtra("accountInfo", accountInfo);
                i.putExtra("accountBalance", accountBalance);
                startActivity(i);
        ...
        // Button to return to main screen (MainAdminActivity)
        Button mReturnButton = (Button) findViewById(R.id.action_return);
        mReturnButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // go to MainAdminActivity
                Intent i = new Intent(AccountAdminActivity.this, MainAdminActivity.class);
                startActivity(i);
