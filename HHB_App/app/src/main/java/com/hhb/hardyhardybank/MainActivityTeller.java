...
/**
 * Landing page from login; menu access to other functionality for Tellers
 */
...
public class MainActivityTeller extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set up EditText item to enter account number
        mAccounts = (EditText) findViewById(R.id.account_number_teller);
        //TODO take input and set account to access
        ...
        mSummaryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(MainActivityTeller.this, DisplayUserInfoActivity.class);
                startActivity(i);
        ...
        mTransferButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(MainActivityTeller.this, TransferActivity.class);
                startActivity(i);
